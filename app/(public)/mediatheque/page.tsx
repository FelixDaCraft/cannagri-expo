...
const editions = [
  {
    ...
    photos: [
      { id: '1', src: '/images/gallery/2024-stand-exchange.jpg', caption: 'Stand Exchange - Échanges entre professionnels' },
      { id: '2', src: '/images/gallery/2024-conference-1.jpg', caption: 'Conférence - Vue d\'ensemble' },
      { id: '3', src: '/images/gallery/2024-conference-2.jpg', caption: 'Conférence - Intervenants' },
      { id: '4', src: '/images/gallery/2024-remise-prix.jpg', caption: 'Remise des prix - Platinum CBD Cup' },
      { id: '5', src: '/images/gallery/2024-samples.jpg', caption: 'Échantillons CBD - Dégustation' },
    ],
  },
]
