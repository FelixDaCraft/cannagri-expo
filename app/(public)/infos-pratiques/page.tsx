        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-body/70">{infos.accessTransport}</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-heading mb-2 flex items-center gap-2">
                      <svg className="w-5 h-5 text-sage" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-body/70">{infos.accessParking}</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-heading mb-2 flex items-center gap-2">
                      <svg className="w-5 h-5 text-sage" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Card variant="elevated" className="overflow-hidden">
              <div className="aspect-video bg-sage/20 relative">
                <iframe
          ...
          <div className="space-y-6">
            {/* Tickets */}
            <Card variant="elevated" className="bg-forest text-white">
              <CardContent>
              ...
              <CardContent>
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className="flex items-center gap-3 text-body hover:text-forest transition-colors"
                  >
                    <svg className="w-5 h-5 text-sage" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <CardContent>
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="w-10 h-10 bg-sage/20 rounded-full flex items-center justify-center text-forest hover:bg-sage/40 transition-colors"
                  >
            ...
            {/* Exhibitor CTA */}
            <Card variant="elevated" className="bg-sage/20">
              <CardContent>
