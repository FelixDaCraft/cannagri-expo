...
async function main() {
  ...
  const standsData = [
    ...
    { number: 3, surfaceM2: 4, priceHT: 150, x: 195, y: 30, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 4, surfaceM2: 4, priceHT: 150, x: 255, y: 30, width: 50, height: 50, status: 'RESERVED' as StandStatus },
    { number: 5, surfaceM2: 4, priceHT: 150, x: 315, y: 30, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 6, surfaceM2: 4, priceHT: 150, x: 375, y: 30, width: 50, height: 50, status: 'SOLD' as StandStatus },
    { number: 7, surfaceM2: 4, priceHT: 150, x: 435, y: 30, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 8, surfaceM2: 4, priceHT: 150, x: 495, y: 30, width: 50, height: 50, status: 'FREE' as StandStatus },
    // Stands 1-2 (à côté conférence)
    { number: 2, surfaceM2: 4, priceHT: 150, x: 195, y: 100, width: 50, height: 50, status: 'SOLD' as StandStatus },
    { number: 1, surfaceM2: 4, priceHT: 150, x: 195, y: 160, width: 50, height: 50, status: 'FREE' as StandStatus },
    // Colonne de droite (stands 9-18)
    { number: 9, surfaceM2: 4, priceHT: 150, x: 555, y: 30, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 10, surfaceM2: 4, priceHT: 150, x: 555, y: 90, width: 50, height: 50, status: 'RESERVED' as StandStatus },
    { number: 11, surfaceM2: 4, priceHT: 150, x: 555, y: 150, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 12, surfaceM2: 4, priceHT: 150, x: 555, y: 210, width: 50, height: 50, status: 'SOLD' as StandStatus },
    { number: 13, surfaceM2: 4, priceHT: 150, x: 555, y: 270, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 14, surfaceM2: 4, priceHT: 150, x: 555, y: 330, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 15, surfaceM2: 4, priceHT: 150, x: 555, y: 390, width: 50, height: 50, status: 'SOLD' as StandStatus },
    { number: 16, surfaceM2: 4, priceHT: 150, x: 555, y: 450, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 17, surfaceM2: 4, priceHT: 150, x: 555, y: 510, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 18, surfaceM2: 4, priceHT: 150, x: 555, y: 570, width: 50, height: 50, status: 'RESERVED' as StandStatus },
    // Rangée du bas (stands 25-19)
    { number: 25, surfaceM2: 4, priceHT: 150, x: 135, y: 570, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 24, surfaceM2: 4, priceHT: 150, x: 195, y: 570, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 23, surfaceM2: 4, priceHT: 150, x: 255, y: 570, width: 50, height: 50, status: 'SOLD' as StandStatus },
    { number: 22, surfaceM2: 4, priceHT: 150, x: 315, y: 570, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 21, surfaceM2: 4, priceHT: 150, x: 375, y: 570, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 20, surfaceM2: 4, priceHT: 150, x: 435, y: 570, width: 50, height: 50, status: 'FREE' as StandStatus },
    { number: 19, surfaceM2: 4, priceHT: 150, x: 555, y: 570, width: 50, height: 50, status: 'FREE' as StandStatus },
  ]
